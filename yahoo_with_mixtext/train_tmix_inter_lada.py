...
if __name__ == "__main__":
    ...
    run_name = 'train_yahoo_on_mixtext_10_per_class_tmix_inter_lada'
    ...
    train_dataset = create_dataset(
        train['X'], train['y'], model_name, 256, mix='Inter_LADA', num_classes=10, knn_lada=args.knn, mu_lada=args.mu)
