...
X, y = read_csv_and_return_x_y('data/ag_news_csv/train.csv', 'ag_news')
...
print(len(X_train))
print(len(X_val))
pickle.dump(train_data, open('data/ag_news_v1/ag_news_full_train.pkl', 'wb'))
pickle.dump(val_data, open('data/ag_news_v1/ag_news_full_val.pkl', 'wb'))
...
for train_index, test_index in sss.split(X_train, y_train):
    ...
    pickle.dump(dataset_here, open(f'data/ag_news_v1/train_val_split_part_{i}.pkl', 'wb'))
    i += 1