...
X_use, _, y_use,_ = train_test_split(X, y, test_size=0.998, random_state=seed, stratify=y)
...
pickle.dump(train_data, open('data/yahoo_answers_0.2_percent/yahoo_answers_train.pkl', 'wb'))
pickle.dump(val_data, open('data/yahoo_answers_0.2_percent/yahoo_answers_val.pkl', 'wb'))
...
#     pickle.dump(dataset_here, open(f'data/yahoo_answers_0.5_percent/train_val_split_part_{i}.pkl', 'wb'))
#     i += 1
