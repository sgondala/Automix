...
parser.add_argument('--stop-decay-after', default=-1, type=int,
                    help='batch size for train')
parser.add_argument('--translation-loss', default=0.2, type=float,
                    help='e final translation loss from the clean inputs of a NMT model')
parser.add_argument('--sampling-ratio', default=0.25, type=float,
                    help='percent of words to replace in input')
...
if __name__ == "__main__":
    ...
    run_name = 'train_sst2_on_mixtext_1_percent_tmix_with_advaug'
    ...
    train_dataset = create_dataset(
        ...
        num_classes=2, translation_loss=args.translation_loss, sampling_ratio=args.sampling_ratio)
